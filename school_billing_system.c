...
void main(void)
{
    ...
    printf("\t|********************************************************|\n");
    printf("\t|________________________________________________________|\n");
    printf("\t|----     DEVELOPED BY: DEVARSYA SHAH (21bt04113)    ----|\n");
    printf("\t|________________________________________________________|\n");
    printf("\t|********************************************************|\n");
    printf("\t|********************************************************|\n");
    printf("\t|________________________________________________________|\n");
    ...
    system("color 15b");//this is for text colour
    ...
    fflush(stdin);//remove previous data from console screen.
    getch();
    system("cls");
    ...
    //login system starts
    char userID[]="PROGRAMCHALEGA", password[]="PATANAHI", id[20], p[6];
    int n=1, x, y;
    do
	{
         printf("\nUSER_ID:");
  ...
  void start()
{
    int l,m;//this is for selection of account type
    system("cls");
    ...
    case 1:// for students
    {
        ...
        fflush(stdin);
        scanf("%d",&l);
        //every time we want to go to start meanu that's why start function is called.
        switch (l)
        {
        case 1:
            ...
            start();//function call
        case 2:
            searching_records(m);//function call
            start();//function call
        case 3:
            update_records(m);
            start();//function call
        case 4:
            deleting_records(m);//function call
            start();//function call
        case 5:
            fee(mm);//function call
            start();//function call
        case 6:
            exits();//function call
        default :
    ...
    case 2://this is for teachers.
    {
        ...
        case 2:
            ...
            start();//function call
        case 3:
            update_records(m);//function call
            start();//function call
        case 4:
            deleting_records(m);//function call
        case 5:
            salary(mm);//function call
            start();//function call
        case 6:
            exits();//function call
        default :
...
void adding_records(int j)
{
    ...
    if (j==1)
    {
        while(cs=='y'||cs=='Y')
        {
            ...
            fee_fee=std.cl/10.0;
            std.fes=2000*(1+fee_fee);//fee of different classes
            ...
            fclose(file_store);
            printf("\n\nDo you want to continue with the process(press y(yes) or n(no)):");
            fflush(stdin);
            cs=getch();
        }
        getch();
